...
var file = cljs.core.get.call(null,map__34667__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__34667__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__34667__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e34666){var _e = e34666;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___34669 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___34669)){
var seen_errors_34670 = temp__5718__auto___34669;
if(cljs.core.truth_(seen_errors_34670.has(self))){
} else {
seen_errors_34670.add(self);

var temp__5720__auto___34671 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___34671)){
var sense_34672 = temp__5720__auto___34671;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_34672)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1630010084321
