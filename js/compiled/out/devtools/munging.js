...
var o32546 = temp__5718__auto__;
var temp__5718__auto____$1 = (o32546["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o32547 = temp__5718__auto____$1;
return (o32547["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__31904__auto__ = f;
return (o__31904__auto__["toString"]).call(o__31904__auto__);
} else {
return "";
}
}catch (e32548){var _ = e32548;
return "";
}});
...
try{var o__31904__auto___32550 = t;
(o__31904__auto___32550["cljs$lang$ctorPrWriter"]).call(o__31904__auto___32550,t,writer);
}catch (e32549){var __32551 = e32549;
}
...
var char_code = (function (){var o__31904__auto__ = (new String(char$));
return (o__31904__auto__["charCodeAt"]).call(o__31904__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__31904__auto__ = String;
return (o__31904__auto__["fromCharCode"]).call(o__31904__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__32552 = num_code;
switch (G__32552) {
case (1):
return (185);
...
var o__31904__auto__ = String;
return (o__31904__auto__["fromCharCode"]).call(o__31904__auto__,superscript_code);
});
/**
...
}catch (e32554){var _e__31911__auto__ = e32554;
return false;
}})())){
...
var vec__32555 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__32555,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o32558 = temp__5718__auto__;
var temp__5718__auto____$1 = (o32558["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o32559 = temp__5718__auto____$1;
return (o32559["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___32566 = arguments.length;
var i__4737__auto___32567 = (0);
while(true){
if((i__4737__auto___32567 < len__4736__auto___32566)){
args__4742__auto__.push((arguments[i__4737__auto___32567]));

var G__32568 = (i__4737__auto___32567 + (1));
i__4737__auto___32567 = G__32568;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__32562){
var vec__32563 = p__32562;
var ns_detector = cljs.core.nth.call(null,vec__32563,(0),null);
...
var G__32569 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__32570 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__32569;
remaining_tokens = G__32570;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq32560){
var G__32561 = cljs.core.first.call(null,seq32560);
var seq32560__$1 = cljs.core.next.call(null,seq32560);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32561,seq32560__$1);
}));
...
var vec__32574 = cljs.core.split_with.call(null,(function (p1__32573_SHARP_){
return cljs.core.not_EQ_.call(null,p1__32573_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__32574,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__32574,(1),null);
...
var vec__32580 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__32580,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__32580,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__32583 = cljs.core.rest.call(null,remaining_tokens);
var G__32584 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__32583;
name_tokens = G__32584;
continue;
} else {
...
var vec__32587 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__32587,(0),null);
var arity = cljs.core.nth.call(null,vec__32587,(1),null);
var vec__32590 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__32590,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__32590,(1),null);
var vec__32593 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__32593,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__32593,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__32593,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__32593,(3),null);
...
var vec__32599 = result;
var munged_ns = cljs.core.nth.call(null,vec__32599,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__32599,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__32599,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__32599,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__32599,(4),null);
var arity = cljs.core.nth.call(null,vec__32599,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__32603 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__32603,(0),null);
var args = cljs.core.nth.call(null,vec__32603,(1),null);
var vec__32606 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__32606,(0),null);
var name = cljs.core.nth.call(null,vec__32606,(1),null);
...
var G__32609 = (arity + (1));
var G__32610 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__32611){
var vec__32612 = p__32611;
var arity = cljs.core.nth.call(null,vec__32612,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__32612,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__32615_SHARP_){
return cljs.core.get.call(null,arities,p1__32615_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__32616_SHARP_){
return cljs.core.drop.call(null,(2),p1__32616_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___32623 = arguments.length;
var i__4737__auto___32624 = (0);
while(true){
if((i__4737__auto___32624 < len__4736__auto___32623)){
args__4742__auto__.push((arguments[i__4737__auto___32624]));

var G__32625 = (i__4737__auto___32624 + (1));
i__4737__auto___32624 = G__32625;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__32619){
var vec__32620 = p__32619;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__32620,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq32617){
var G__32618 = cljs.core.first.call(null,seq32617);
var seq32617__$1 = cljs.core.next.call(null,seq32617);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__32618,seq32617__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__32628__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__32628__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__32628__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__32628__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__32629 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__32629,(0),null);
var fn_name = cljs.core.nth.call(null,vec__32629,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__32629,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__32629,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__32629,(4),null);
var arity = cljs.core.nth.call(null,vec__32629,(5),null);
...
var o__31904__auto__ = f;
return (o__31904__auto__["getBasis"]).call(o__31904__auto__);
});
/**
...
}catch (e32633){var _e__31911__auto__ = e32633;
...
var G__32634 = (obj[cljs.core.first.call(null,path)]);
var G__32635 = cljs.core.rest.call(null,path);
obj = G__32634;
path = G__32635;
continue;
} else {
...
var _STAR_ = (function (accum,p__32636){
var vec__32637 = p__32636;
var bit = cljs.core.nth.call(null,vec__32637,(0),null);
var protocol = cljs.core.nth.call(null,vec__32637,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__32640){
var vec__32641 = p__32640;
var ns = cljs.core.nth.call(null,vec__32641,(0),null);
var name = cljs.core.nth.call(null,vec__32641,(1),null);
var selector = cljs.core.nth.call(null,vec__32641,(2),null);
...
var post_process = (function (p__32645){
var vec__32646 = p__32645;
var munged_name = cljs.core.nth.call(null,vec__32646,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__32646,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__32644_SHARP_){
return (obj[cljs.core.first.call(null,p1__32644_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1630010080908
