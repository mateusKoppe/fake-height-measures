...
return (new CustomEvent(event_name,(function (){var obj38000 = ({"detail":data});
return obj38000;
})()));
} else {
...
var f = (function (){var pred__38007 = cljs.core._EQ_;
var expr__38008 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__38007.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__38008))){
return (function (p1__38001_SHARP_){
return console.warn(p1__38001_SHARP_);
});
} else {
if(cljs.core.truth_(pred__38007.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__38008))){
return (function (p1__38002_SHARP_){
return console.debug(p1__38002_SHARP_);
});
} else {
if(cljs.core.truth_(pred__38007.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__38008))){
return (function (p1__38003_SHARP_){
return console.error(p1__38003_SHARP_);
});
} else {
return (function (p1__38004_SHARP_){
return console.log(p1__38004_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__38011){
...
var opts = map__38012__$1;
var eval_fn = cljs.core.get.call(null,map__38012__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__38014_SHARP_){
return new_def.callback(p1__38014_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__38015){
var vec__38016 = p__38015;
var ky = cljs.core.nth.call(null,vec__38016,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1630010086254
