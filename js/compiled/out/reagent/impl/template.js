...
var G__35459 = o;
goog.object.set(G__35459,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__35461__i < G__35461__a.length) {G__35461__a[G__35461__i] = arguments[G__35461__i + 0]; ++G__35461__i;}
  args = new cljs.core.IndexedSeq(G__35461__a,0,null);
} 
...
var G__35463 = o;
goog.object.set(G__35463,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__35464__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__35465__i < G__35465__a.length) {G__35465__a[G__35465__i] = arguments[G__35465__i + 0]; ++G__35465__i;}
  args = new cljs.core.IndexedSeq(G__35465__a,0,null);
} 
...
var args = cljs.core.seq(arglist__35466);
...
var G__35467 = props;
var G__35467__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35467,cljs.core.cst$kw$id,id):G__35467);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35467__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__35467__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__35468 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35468,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__35468;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__35469){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35470__$1,cljs.core.cst$kw$on_DASH_write);
...
return (jsprops.onChange = (function (p1__35472_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__35472_SHARP_);
}));
} else {
return null;
}
...
var vec__35475 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35475,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35475,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35475,(2),null);
...
var temp__5724__auto___35479 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___35479 == null)){
} else {
var key_35480 = temp__5724__auto___35479;
(jsprops.key = key_35480);
}
...
var temp__5724__auto___35481 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___35481 == null)){
} else {
var key_35482 = temp__5724__auto___35481;
(jsprops.key = key_35482);
}
...
var G__35483 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__35483) : reagent.impl.template.as_element.call(null,G__35483));
} else {
var temp__5724__auto___35484 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___35484 == null)){
} else {
var key_35485 = temp__5724__auto___35484;
(jsprops.key = key_35485);
}
...
var G__35487 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__35487)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__35487)){
return x;
} else {
...
var len__4736__auto___35490 = arguments.length;
var i__4737__auto___35491 = (0);
while(true){
if((i__4737__auto___35491 < len__4736__auto___35490)){
args__4742__auto__.push((arguments[i__4737__auto___35491]));

var G__35492 = (i__4737__auto___35491 + (1));
i__4737__auto___35491 = G__35492;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35488){
var G__35489 = cljs.core.first(seq35488);
var seq35488__$1 = cljs.core.next(seq35488);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35489,seq35488__$1);
}));
...
break;
default:
var G__35495 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__35495;
continue;
...
var ctx = ({});
var vec__35497 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35497,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35497,(1),null);
...
var G__35500 = (cljs.core.count(argv) - first_child);
switch (G__35500) {
case (0):
...
break;
case (1):
var G__35501 = component;
var G__35502 = jsprops;
var G__35503 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__35501,G__35502,G__35503);
