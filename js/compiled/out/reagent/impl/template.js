...
var G__31283 = o;
goog.object.set(G__31283,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__31285__i < G__31285__a.length) {G__31285__a[G__31285__i] = arguments[G__31285__i + 0]; ++G__31285__i;}
  args = new cljs.core.IndexedSeq(G__31285__a,0,null);
} 
...
var G__31287 = o;
goog.object.set(G__31287,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__31288__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__31289__i < G__31289__a.length) {G__31289__a[G__31289__i] = arguments[G__31289__i + 0]; ++G__31289__i;}
  args = new cljs.core.IndexedSeq(G__31289__a,0,null);
} 
return G__31288__delegate.call(this,args);};
G__31288.cljs$lang$maxFixedArity = 0;
G__31288.cljs$lang$applyTo = (function (arglist__31290){
var args = cljs.core.seq(arglist__31290);
return G__31288__delegate(args);
});
...
var G__31291 = props;
var G__31291__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__31291,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31291);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__31291__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__31291__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__31292 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__31292,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__31292;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__31293){
...
var on_write = cljs.core.get.call(null,map__31294__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__31296_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__31296_SHARP_);
}));
} else {
return null;
}
...
var vec__31299 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__31299,(0),null);
var id = cljs.core.nth.call(null,vec__31299,(1),null);
var className = cljs.core.nth.call(null,vec__31299,(2),null);
...
var temp__5724__auto___31303 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___31303 == null)){
} else {
var key_31304 = temp__5724__auto___31303;
(jsprops.key = key_31304);
}
...
var temp__5724__auto___31305 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___31305 == null)){
} else {
var key_31306 = temp__5724__auto___31305;
(jsprops.key = key_31306);
}
...
var temp__5724__auto___31307 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5724__auto___31307 == null)){
} else {
var key_31308 = temp__5724__auto___31307;
(jsprops.key = key_31308);
}
...
var G__31310 = n;
if(cljs.core._EQ_.call(null,"",G__31310)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__31310)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq31311){
var G__31312 = cljs.core.first.call(null,seq31311);
var seq31311__$1 = cljs.core.next.call(null,seq31311);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__31312,seq31311__$1);
}));
...
break;
default:
var G__31318 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__31318;
continue;
...
var ctx = ({});
var vec__31320 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__31320,(0),null);
var derefed = cljs.core.nth.call(null,vec__31320,(1),null);
...
var G__31323 = (cljs.core.count.call(null,argv) - first_child);
switch (G__31323) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1630010078830
